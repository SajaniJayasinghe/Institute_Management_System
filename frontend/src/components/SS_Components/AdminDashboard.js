     ...
     <AdminNavBar/><br/><br/>
      <div className="container">
         <div className="container">
           <div class="row row-cols-1 row-cols-md-4 g-4" style={{marginLeft:"130px"}}>
            ...
            <div class="card-body" style={{background: "#8BC0FF"}}>
              <h5 class="card-title" id="dashh5" align="center"><b> Project Resourses</b></h5>
            </div>
            </div>
        </div>
        ...
        <a href="/"><img
            ...
            /></a>
             <div class="card-body" style={{background: "#8BC0FF"}}>
              <h5 class="card-title" id="dashh5" align="center"><b>Blog Management</b></h5>
            </div>
            </div>
        </div>
        ...
        <div class="col">
            ...
            /></a>
            <div class="card-body" style={{background: "#8BC0FF"}}>
              <h5 class="card-title" id="dashh5" align="center"><b>Feedbacks Management</b></h5>
            </div>
            </div>
        </div>
           </div>
        ...
        <a href="/"><img
            ...
            /></a>
             <div class="card-body" style={{background: "#8BC0FF"}}>
              <h5 class="card-title" id="dashh5" align="center"><b>Student Management</b></h5>
            </div>
            </div>
        </div>
        ...
        <a href="/advertisement"><img
            ...
            /></a>
             <div class="card-body" style={{background: "#8BC0FF"}}>
              <h5 class="card-title" id="dashh5" align="center"><b>Emails</b></h5>
            </div>
            </div>
        </div>
           </div>
