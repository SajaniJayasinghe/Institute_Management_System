...
// Observe state change events such as progress, pause, and resume
    ...
    axios.put(`http://localhost:8070/course/update/${courseID}`, updateCourse).then((res) => {
      if (res.data) {
                   ...
                   <form action="" method="post" name="form"onSubmit={onUpdate}>
                     <div style={{display:'flex'}}>
                      ...
                      <div class="col-xl-10" style={{flex:1}}><br/>  
                           ...
                           <b><u>Update&nbsp;Course  Details</u></b></h3><br/>
                     
                      <div style={{display:"flex" , alignItems:"center"}}>
                         <div style={{minWidth :"165px",maxWidth:"100px"}}>
                           1. Course Name  
                            </div>
                              <input type="text" class="form-control"  value={course_name} 
                      ...
                      <div style={{display:"flex" , alignItems:"center"}}>
                        <div style={{minWidth :"165px",maxWidth:"100px"}} >
                           ...
                           <input type="text"   class="form-control"  value={course_code} 
                            name="course_code" placeholder='Enter course code'
                            onChange={(e) => { setcourse_code(e.target.value) }}/><br/><br/>
                      </div>
                      ...
                      <div style={{display:"flex" , alignItems:"center"}}>
                        <div style={{minWidth :"165px",maxWidth:"100px"}} >
                          ...
                          <input type="text"   class="form-control" value={lecture_name} 
                      ...
                      <div style={{display:"flex" , alignItems:"center"}}>
                         <div style={{minWidth :"165px",maxWidth:"100px"}} >
                            ...
                            disableElevation type="submit" >UPDATE</Button>&nbsp; &nbsp; 
