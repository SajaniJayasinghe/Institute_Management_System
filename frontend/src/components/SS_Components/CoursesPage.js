       ...
       <div class="content text-color p-2">
         ...
         <Typography component={'span'} variant={'body2'}>
            <div className="row" style={{ paddingLeft: 0 }} >
               <div className="text-color" style={{fontSize: 18, paddingBottom: 8}} 
                    align='left'>{lecture_name}
               </div>
            </div> 
                
            <div align="right">
              <Button variant="contained" style={{background: "#8BC0FF", width: 9+"%",color:"BLACK",borderRadius: 20,}}
                onClick={CourseHome}  disableElevation type="submit" >VIEW</Button>
            </div>
         </Typography>
       </div>
 </div>
